    ...
    class Program
    {
        static void Main()
        {
            string connectionString =
                "Server=(localdb)\\MSSQLLocalDB;Database=JECRC;Trusted_Connection=True;";
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT EMPLOYEE_ID, EMPLOYEE_NAME, EMPLOYEE_DEPARTMENT, EMPLOYEE_SALARY FROM Employee";
                    ...
                    using (SqlDataReader reader = cmd.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            employees.Add(new Employee
                            {
                                ...
                                EMPLOYEE_SALARY = reader.GetDecimal(3)
                            });
                        }
                    }
                }
